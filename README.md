...
| [`chapter4/`](chapter4/README.md) | 第 4 章 実践的データモデリング | staging / intermediate / marts の 3 層構造とディメンショナルモデルを構築する | PostgreSQL 17（`dbt-postgres`） | ローカル（Docker） |
