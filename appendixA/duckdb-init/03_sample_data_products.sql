...
('料理レシピ本', 'BOOK-COOK-001', 'BOOK-COOKING-RECIPE', 5, 5, 1980.00, '家庭料理レシピ集 100選', '{"category": "料理", "recipes": 100, "level": "初級〜中級", "pages": 240, "publisher": "クッキング出版", "isbn": "978-4-23456-789-0"}'),
...
('小説 ベストセラー', 'BOOK-NOVEL-001', 'BOOK-NOVEL-BESTSELLER', 5, 5, 1580.00, '話題の小説 ベストセラー', '{"category": "小説", "genre": "現代文学", "pages": 350, "publisher": "文芸出版", "isbn": "978-4-45678-901-2"}'),
('健康・ダイエット本', 'BOOK-HEALTH-001', 'BOOK-HEALTH-DIET', 5, 5, 1380.00, '健康的なダイエット法', '{"category": "健康", "topic": "ダイエット", "pages": 200, "publisher": "健康出版", "isbn": "978-4-56789-012-3"}'),
...
-- 本・メディア
(20, 100, 20, 50, 80), -- プログラミング入門書
(21, 75, 15, 30, 60),  -- 料理レシピ本
(22, 90, 18, 40, 70),  -- ビジネス書

-- エレクトロニクス - 家電
(23, 12, 2, 5, 10),   -- 4K液晶テレビ
(24, 8, 1, 3, 8),     -- 冷蔵庫
(25, 15, 3, 6, 12),   -- 洗濯機
(26, 25, 5, 10, 20),  -- エアコン

-- ファッション - バッグ・靴・小物
(27, 18, 3, 8, 15),   -- レザーハンドバッグ
(28, 30, 6, 12, 25),  -- ビジネスシューズ
(29, 22, 4, 10, 20),  -- 腕時計

-- ホーム・キッチン - インテリア
(30, 6, 1, 2, 8),     -- ソファ
(31, 10, 2, 4, 10),   -- ダイニングテーブル
(32, 15, 3, 6, 12),   -- ベッド
(33, 45, 9, 20, 35),  -- カーテン

-- スポーツ・アウトドア
(34, 60, 12, 25, 50), -- ヨガマット
(35, 20, 4, 8, 18),   -- ダンベルセット
(36, 8, 1, 3, 10),    -- 自転車

-- 本・メディア
(37, 120, 24, 50, 100), -- 小説
(38, 80, 16, 35, 70),   -- 健康・ダイエット本
(39, 65, 13, 25, 50),   -- 旅行ガイドブック
